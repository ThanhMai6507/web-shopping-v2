...
<head>
    ...
    <!-- Feathericon CSS -->
    <link rel="stylesheet" href="<?php echo e(asset('css/feathericon.min.css')); ?>  ">
...
<body>
    ...
    <div class="main-wrapper">
        ...
        <div class="header">
            ...
            <div class="header-left">
                <a href="#" class="logo">
                    <img src=" <?php echo e(asset('public/img/logo2.png')); ?> " alt="Logo">
                </a>
    ...
    <script src="<?php echo e(asset('js/chart.morris.js')); ?> "></script>
...
<?php /**PATH /var/www/html/web-ban-hang-larave/resources/views/layouts/admin/adminlayout.blade.php ENDPATH**/ ?>