                            ...
                            <div>
                                <div class="product-img">
                                    <input type="button" value="Add Cart" class="btn btn-primary add-to-cart"
                                           data-id_product="<?php echo e($product->id); ?>" name="add-to-cart">
                                </div>
                            </div>
                            <input type="hidden" value="<?php echo e($product->id); ?>" class="cart_product_id_<?php echo e($product->id); ?>">
                            <input type="hidden" value="<?php echo e($product->name_product); ?>"
                                   class="cart_product_name_<?php echo e($product->id); ?>">
                            <input type="hidden" value="<?php echo e($product->img_product); ?>"
                                   class="cart_product_image_<?php echo e($product->id); ?>">
                            <input type="hidden" value="<?php echo e($product->price); ?>"
                                   class="cart_product_price_<?php echo e($product->id); ?>">
